...
const editCard = (e) => {
    ...
    summitButton = parentNode.childNodes[5].childNodes[1];
    taskType =  parentNode.childNodes[3].childNodes[7].childNodes[1];

    taskTitle.setAttribute("contenteditable","true");
    taskDescription.setAttribute("contenteditable","true");
    taskType.setAttribute("contenteditable","true");
    summitButton.setAttribute("onclick","saveEdit.apply(this,arguments)");
    summitButton.innerHTML = "Save Changes"
...
const saveEdit = (e) => {
    ...
    const summitButton = parentNode.childNodes[5].childNodes[1];
    ...
    summitButton.innerHTML = "Open Task"
